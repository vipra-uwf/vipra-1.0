...
public:
    Simulation();
    Simulation(Numeric mean_t, Numeric stddev_t, Numeric Intersection_Distance_Threshold, Numeric Intersection_Speed_Coefficient, Numeric Aligning_Speed_Coefficient, Numeric Toward_Aisle_Speed_Coefficient, Numeric Release_Threshold, int id);
    Numeric getMean();
    Numeric getStddev();
    int getOutputIndex();
    ...
    vector<Numeric> Initialize(Passengers &passengers_t, Obstacles &obstacles_t, vector<string>& xyz_obs, vector<pair<int, int> >&arrangement, ofstream& output);
    ...
    void raceDetection(Passengers& passengers, const int& ID, const Numeric& time_step, ofstream& output);
