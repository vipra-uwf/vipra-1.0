 ...
 * 
 */
void ThermostatCollision::raceDetection(const VIPRA::PedestrianSet& pedestrianSet,
...
RaceStatus ThermostatCollision::status(VIPRA::idx index) const { return raceStatuses.at(index); }

bool ThermostatCollision::pedInRace(VIPRA::idx index) const { 

  for(VIPRA::idx i = 0; i < inRace.size(); i++) {
 ...
 * 
 */
void ThermostatCollision::calcCollisionRectangles(const VIPRA::PedestrianSet& pedestrianSet,
 ...
 * 
 */
bool ThermostatCollision::checkIfHighestPriority(const VIPRA::PedestrianSet& pedestrianSet,
 ...
 * @return false 
 */
bool ThermostatCollision::checkIfCollide(VIPRA::idx index1, VIPRA::idx index2) {
 ...
 * @return VIPRA::f3d 
 */
VIPRA::f3d ThermostatCollision::getCollisionAreaMidpoint(VIPRA::idx index1, VIPRA::idx index2) {
...
void ThermostatCollision::addIntersectionPoints(VIPRA::f3d p1, VIPRA::f3d q1, VIPRA::f3d p2,
...
void ThermostatCollision::initializeRectangles(const VIPRA::PedestrianSet& pedestrianSet,
...
void ThermostatCollision::assignRaceStatuses(std::vector<RaceStatus>& cpmRaceStatuses, std::vector<std::vector<bool>>& cpmInRace)
{
  cpmRaceStatuses = raceStatuses;
  cpmInRace = inRace;
}

void ThermostatCollision::initialize(const VIPRA::PedestrianSet& pedestrianSet,
                           const VIPRA::Goals& goals, const ModelData& data) {
