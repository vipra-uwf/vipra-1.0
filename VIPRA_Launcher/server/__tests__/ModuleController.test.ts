...
import { checkInstalledGoodModule, duplicateModuleInfo, goodModuleBuffers, goodModuleInfo, installedModulesInfo, installedOutputDataWriters, mockInstalledModels, NON_EXISTANT_MODULE_ID } from './values/modules';
...
describe('ModuleController', () =>{
    ...
    it("Should Load Modules on construction", ()=>{
        ...
        expect(moduleController.getModules()).toMatchObject(mockInstalledModels());
    });
