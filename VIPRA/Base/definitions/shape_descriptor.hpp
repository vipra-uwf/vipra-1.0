...
struct shape {
  ...
  ~shape() = default;
  constexpr explicit shape() noexcept
      : centerpointx(0), centerpointy(0), length(0), width(0), radius(0) {}
  constexpr explicit shape(float centerpointx, float centerpointy) noexcept
      : centerpointx(centerpointx),
        centerpointy(centerpointy),
        length(0),
        width(0),
        radius(0) {}
  constexpr explicit shape(float centerpointx, float centerpointy, float radius) noexcept
      : centerpointx(centerpointx),
        centerpointy(centerpointy),
        length(0),
        width(0),
        radius(radius) {}
  constexpr explicit shape(float centerpointx, float centerpointy, float length,
      ...
      : centerpointx(centerpointx),
        ...
        radius(0) {}
  constexpr explicit shape(float centerpointx, float centerpointy, float length,
                           float width, float radius) noexcept
      : centerpointx(centerpointx),
        centerpointy(centerpointy),
        length(length),
        width(width),
  ...
  inline constexpr shape operator-(const shape& other) const noexcept {
    return shape{centerpointx - other.centerpointx, centerpointy - other.centerpointy,
                 length - other.length, width - other.width, radius - other.radius};
  }
  inline constexpr shape operator-(shape&& other) const noexcept {
    return shape{centerpointx - other.centerpointx, centerpointy - other.centerpointy,
                 length - other.length, width - other.width, radius - other.radius};
  }
  ...
  inline constexpr bool operator==(const shape& other) const noexcept {
    return (centerpointx == other.centerpointx && centerpointy == other.centerpointy &&
            length == other.length && width == other.width && radius == other.radius);
  }
  inline constexpr bool operator==(shape&& other) const noexcept {
    return (centerpointx == other.centerpointx && centerpointy == other.centerpointy &&
            length == other.length && width == other.width && radius == other.radius);
  }
  ...
  inline constexpr shape operator-() const noexcept {
    return shape{-centerpointx, -centerpointy, -length, -width, -radius};
  }
};
...
inline constexpr const shape _emptyshape_ =  // NOLINT
    VIPRA::shape{std::numeric_limits<float>::max(), std::numeric_limits<float>::max(),
