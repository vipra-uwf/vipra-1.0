...
class BehaviorsParser : public antlr4::Parser {
 public:
  ...
  enum {
    ...
    RuleConsideration = 2,
    RuleStateSelector = 3,
    RuleIdRatioSelector = 4,
    RuleExactlyNRandomSelector = 5,
    RuleRandomIdRatioStatement = 6,
    RuleRandomIdRatioSelector = 7,
    RuleConditionElapsedTime = 8,
    RuleConditionEnvironmentState = 9,
    RuleEveryoneSelector = 10,
    RuleEnvironmentStateDeclaration = 11,
    RuleEnvironmentInitialStateDeclaration = 12,
    RuleEnvironmentTransition = 13,
    RuleStateDeclaration = 14,
    RuleInitialStateDeclaration = 15,
    RulePedestrianSelected = 16,
    RuleStateTransitionElapsedTime = 17,
    RuleStateTransitionEnvironmentState = 18,
    RuleFasterOrSlower = 19,
    RuleTowardOrAwayFrom = 20,
    RuleTarget = 21,
    RuleStoppedBehavior = 22,
    RuleWalkSpeedBehavior = 23,
    RuleWalkSpeedWithTargetBehavior = 24,
    RuleNormalBehavior = 25,
    RuleStateAction = 26
  };

  BehaviorsParser(antlr4::TokenStream* input);
  ~BehaviorsParser();
