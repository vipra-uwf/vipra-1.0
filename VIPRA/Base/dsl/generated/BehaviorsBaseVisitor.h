...
class BehaviorsBaseVisitor : public BehaviorsVisitor {
 public:
  ...
  virtual antlrcpp::Any visitExactlyNRandomSelector(
      BehaviorsParser::ExactlyNRandomSelectorContext* ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitRandomIdRatioStatement(
      BehaviorsParser::RandomIdRatioStatementContext* ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitNoGroupRandomIdSelector(
      BehaviorsParser::NoGroupRandomIdSelectorContext* ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitGroupingRandomIdSelector(
      BehaviorsParser::GroupingRandomIdSelectorContext* ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitConditionElapsedTime(
      BehaviorsParser::ConditionElapsedTimeContext* ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitConditionEnvironmentState(
      BehaviorsParser::ConditionEnvironmentStateContext* ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitEnvironmentTransition(
      BehaviorsParser::EnvironmentTransitionContext* ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitInitialStateDeclaration(
      BehaviorsParser::InitialStateDeclarationContext* ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitWalkSpeedWithTargetBehavior(
      BehaviorsParser::WalkSpeedWithTargetBehaviorContext* ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitStateActionWalkSpeed(
      BehaviorsParser::StateActionWalkSpeedContext* ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitStateActionWalkSpeedWithTarget(
      BehaviorsParser::StateActionWalkSpeedWithTargetContext* ctx) override {
    return visitChildren(ctx);
  }
