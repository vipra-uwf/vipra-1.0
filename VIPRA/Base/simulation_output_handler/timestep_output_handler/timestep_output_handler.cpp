...
bool TimestepOutputHandler::isOutputCriterionMet(const PedestrianSet&, const ObstacleSet&,
                                                 const Goals&, VIPRA::t_step timestep) {
  return (timestep % frequency == 0);
}

void TimestepOutputHandler::writeOutput(OutputDataWriter&    outputDataWriter,
