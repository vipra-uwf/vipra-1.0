...
#define BUSINESS_THRESHOLD 18
#define FIRST_ECO_Y 7.5
#define FIRST_BUS_Y 1.8
...
enum PassengerAims {TOWARD_AISLE, UP_TO_SEAT, DOWN_TO_SEAT, IN_AISLE, UNLOADONG_LUGGAGE, READY_FOR_TAKE_OFF};
